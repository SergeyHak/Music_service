        ...
        <S.PlaylistItem>
            <S.Track onClick={(e) => playTrackHandler(e)}>
                <S.TrackTitle onClick={(e) => playTrackHandler(e)}>
                    <S.TrackImageWrapper>
                        <S.TrackIconWrapper style={{ backgroundColor: theme.colorA }}>
                            <S.TrackIconImage src={note} alt="music" />
                        </S.TrackIconWrapper>
                    </S.TrackImageWrapper>
                    <S.TrackTitleText id={id}>
                        <S.TrackTitleLink style={{color:theme.color}}
                            id={id}
                ...
                <S.TrackAuthor style={{color:theme.color}} >{trackAuthorText}</S.TrackAuthor>
